...
REQUIRED = [
    ...
    ("INVITE", "the word on a dweller row, which is not a grant"),
    ("CurrentSaveSlot", "the save slot a vault is keyed by"),
    ("m_addedPopulation", "what a living quarters actually sleeps"),
    ("WorkingRoom", "the room a dweller is read as working in"),
